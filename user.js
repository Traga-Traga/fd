...
// @description  ƇƖαη 邪神 Agαrio
// @author       Traga-Traga
// @require      https://raw.githubusercontent.com/Traga-Traga/fd/master/user.js
// @match        *://agar.io/*
// @updateURL    https://cdn.ogario.ovh/v4/beta/
// @downloadURL  https://cdn.ogario.ovh/v4/beta/
                ...
                function checkIP_Token(){
                    ...
                    if(tkip.indexOf(".")==2 || tkip.indexOf(".")==3 || tkip.indexOf(".")==4){
                        ...
                        joinParty($('#partyTokenK').val());
                                ...
                                $(".side-container.left-side").append('<div id="PrivateServersPanel" class="agario-panel agario-side-panel agarioProfilePanel privateserverspanelclass"><select id="PrivateServer" class="form-control privateServer" style="height: 35px; display: block; width: 100%; float: left; margin-bottom: 10px;"><option value="Private Servers" disabled="" default="" selected="" style="display: none;width:100%">Private Servers</option><option value="Pick A Server!">\=\=\=\= Party Servers \=\=\=\=</option><option value="ws://52.34.171.138:443">Splitrun Party</option><option value="ws://198.211.96.100:446">Peridax (1)</option><option value="ws://198.211.96.100:444">Peridax (2)</option><option value="ws://198.211.96.100:501">Peridax (3)</option><option value="ws://parisgamma.iomods.com:1501">Private Party</option><option value="ws://wahm-wahm21.c9users.io:8080">Small Party Server(WiP)</option><option value="Pick A Server!">\=\=\=\= Misc Servers \=\=\=\=</option><option value="ws://vps56296.vps.ovh.ca:443">Huge Map + SelfFeed</option><option value="ws://vps62061.vps.ovh.ca:443">Juggernaut Mode</option></select><button class="btn btn-nosx joinPrivate1" style="height:35px;margin-bottom: 10px;width:100%;" onclick="$(\'.partyToken\').val($(\'#PrivateServer\').val()); connect($(\'#PrivateServer\').val());">Connect</button></div>');//<option value="ws://ffa1.unnamedcell.com:443">Unlimited Split</option><option value="ws://agario.willsr71.net:8080">Fast Merge</option><option value="ws://merge101-universalagar.c9users.io">REAL InstantMerge</option><option value="ws://185.38.150.94:443">W = Virus</option><option value="ws://fuckogar-universalagar-1.c9users.io">Splitrun Training</option><option value="ws://198.199.89.222:443">Splitrun Server (2)</option>
